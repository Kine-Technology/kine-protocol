...
contract KMCDStorageV1 {
    ...
    */
     ...
     */
    KineControllerInterfaceV1 public controller;
...
contract KMCDInterfaceV1 is KMCDStorageV1 {
    /**
     ...
     */
    event NewController(KineControllerInterfaceV1 oldController, KineControllerInterfaceV1 newController);
    ...
    function _setController(KineControllerInterfaceV1 newController) public;
}