...
---
Kine is a decentralized protocol which establishes general purpose liquidity pools backed by a customizable portfolio of digital assets. The liquidity pool allows traders to enter and exit derivatives contracts directly according to trusted price feeds, avoiding the need of counterparties. This mechanism lifts the restriction on existing peer-to-pool (aka peer-to-contract) trading protocols, by expanding the collateral space to any Ethereum-based assets.
